...
type LayoutRouteId = RouteId | "/" | "/(auth)/about" | "/(auth)/auth" | "/(auth)/contact" | "/(auth)/dashboard" | "/(auth)/home" | "/(auth)/home/test" | "/(auth)/profile" | "/(auth)/services" | "/api/boat" | "/login" | "/signup" | null
