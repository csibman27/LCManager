...
type RouteParams = {  };
type RouteId = '/protected/api/boat';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/protected/api/boat/+page.server.js').load>>>>>>;
