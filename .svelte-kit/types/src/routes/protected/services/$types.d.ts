...
type RouteParams = {  };
type RouteId = '/protected/services';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/protected/services/+page.server.js').load>>>>>>;
